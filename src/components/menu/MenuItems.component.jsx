    ...
    return (
        <div className="menu-items-wrapper" ref={menuItemRef}>
            <span className="container-flex cancel-search-wrapper">
                <Input type="search" id={searchInputId} placeholder="Search Coffee" />
                ...
                <div>
                    <div className="container-flex">
                        <span className="container-flex">
                            <Image src={`${process.env.PUBLIC_URL}/assets/images/usd.png`} alt="" />{" "}
                            USD
                        </span>
                        <span className="container-flex">
                            <Image
                                src={`${process.env.PUBLIC_URL}/assets/images/euro.png`}
                                alt=""
                            />{" "}
                            EUR
                        </span>
                    ...
                    <div className="container-flex">
                        <span className="container-flex">
                            <Image src={`${process.env.PUBLIC_URL}/assets/images/aud.png`} alt="" />{" "}
                            AUD
                        </span>
                        <span className="container-flex">
                            <Image src={`${process.env.PUBLIC_URL}/assets/images/gbp.png`} alt="" />{" "}
                            GBP
                        </span>
                    </div>
                </div>
